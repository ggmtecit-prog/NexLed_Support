(() => {
    ...
    const SUPPORT_SHELL_COPY = {
        ...
        warranty: {
            pt: 'Cobertura da Garantia',
            en: 'Warranty Coverage',
            es: 'Cobertura de Garant\u00eda',
        ...
        openSupportRequest: {
            pt: 'Enviar Pedido de Suporte',
            en: 'Submit a Support Request',
            es: 'Enviar solicitud de soporte',
            fr: 'Envoyer une demande d’assistance',
        },
        viewRepairGuides: {
            pt: 'Explorar Guias de Repara\u00e7\u00e3o',
            en: 'Browse Repair Guides',
            es: 'Explorar gu\u00edas de reparaci\u00f3n',
            fr: 'Parcourir les guides de r\u00e9paration',
        },
        viewDownloads: {
            pt: 'Explorar Downloads',
            en: 'Browse Downloads',
            es: 'Explorar descargas',
            fr: 'Parcourir les t\u00e9l\u00e9chargements',
        },
    };
